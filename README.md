...
<!-- ===================== PLATFORM & STACK (BIG BADGES) ===================== -->

![OS](https://img.shields.io/badge/OS-Ubuntu%2020.04-orange?style=for-the-badge&logo=ubuntu)
![Linux](https://img.shields.io/badge/Linux-Cloud%20Lab-black?style=for-the-badge&logo=linux)
...
![Camel](https://img.shields.io/badge/Apache%20Camel-3.x-FFCC00?style=for-the-badge&logo=apache)
![SpringBoot](https://img.shields.io/badge/Spring%20Boot-2.7.x-6DB33F?style=for-the-badge&logo=springboot)

<!-- ===================== INTEGRATION FOCUS (BIG BADGES) ===================== -->

![Focus](https://img.shields.io/badge/Focus-Cloud--Native%20Integration-1F6FEB?style=for-the-badge)
![EIP](https://img.shields.io/badge/EIPs-Routing%20%7C%20Splitter%20%7C%20Aggregator-7C3AED?style=for-the-badge)
![Reliability](https://img.shields.io/badge/Reliability-Retry%20%7C%20DLQ%20%7C%20Fallback-111827?style=for-the-badge)
![REST](https://img.shields.io/badge/REST-API%20Engineering-0EA5E9?style=for-the-badge)
![Messaging](https://img.shields.io/badge/Messaging-ActiveMQ%20%7C%20Kafka-22C55E?style=for-the-badge)
![Transactions](https://img.shields.io/badge/Transactions-JTA%2FXA%20%7C%20Atomikos-F97316?style=for-the-badge)

<!-- ===================== CLOUD-NATIVE (BIG BADGES) ===================== -->

![OpenShift](https://img.shields.io/badge/OpenShift-4.x-EE0000?style=for-the-badge&logo=redhatopenshift)
![Kubernetes](https://img.shields.io/badge/Kubernetes-HPA%20%7C%20Scaling-326CE5?style=for-the-badge&logo=kubernetes)
![CamelK](https://img.shields.io/badge/Camel%20K-Operator%20Deployment-3B82F6?style=for-the-badge)
![Observability](https://img.shields.io/badge/Observability-Logs%20%7C%20Metrics%20%7C%20Health-14B8A6?style=for-the-badge)

<!-- ===================== REPO STATUS (GENERIC; WORKS WITHOUT GITHUB OWNER/REPO) ===================== -->

![Labs](https://img.shields.io/badge/Labs-20%20Hands--On-success?style=for-the-badge)
...
![Stars](https://img.shields.io/github/stars/abdul4rehman215/Red-Hat-Certified-Specialist-in-Cloud-native-Integration?style=for-the-badge)
...
![Category](https://img.shields.io/badge/Category-Camel%20Foundations-0F172A?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-Java%20DSL%20%7C%20XML%20DSL-2563EB?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-Processors%20%7C%20Core%20EIPs-7C3AED?style=for-the-badge)

</div>

| Lab | Title                                                                                    | Core Focus                                              |
| --: | ---------------------------------------------------------------------------------------- | ------------------------------------------------------- |
|  01 | [Setting Up the Camel Environment](./lab01-setting-up-the-camel-environment)             | Karaf + ActiveMQ + Camel runtime                        |
|  02 | [Creating Simple Camel Routes (Java DSL)](./lab02-creating-simple-camel-routes-java-dsl) | RouteBuilder, processors, headers, error routing        |
|  03 | [Defining Routes with XML DSL](./lab03-defining-routes-with-xml-dsl)                     | Spring Boot XML routes + production-style orchestration |
...
![Category](https://img.shields.io/badge/Category-Testing%20%26%20Reliability-0F172A?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-JUnit5%20%7C%20MockEndpoint-16A34A?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-ActiveMQ%20%7C%20Kafka%20%7C%20DLQ-F97316?style=for-the-badge)

</div>

| Lab | Title                                                                                | Core Focus                                                  |
| --: | ------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
|  06 | [Testing Camel Routes with JUnit](./lab06-testing-camel-routes-with-junit)           | camel-test-junit5, MockEndpoint, concurrency checks         |
|  07 | [Error Handling and DLQ](./lab07-error-handling-and-dlq)                             | retries/backoff + DLQ taxonomy + monitoring consumers       |
|  08 | [Integrating Camel with ActiveMQ](./lab08-integrating-camel-with-activemq)           | queues/topics + pub/sub + aggregation + request-reply + DLQ |
...
![Category](https://img.shields.io/badge/Category-REST%20%26%20Cloud--Native%20Deployment-0F172A?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-REST%20DSL%20%7C%20External%20API%20Integration-0EA5E9?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-OpenShift%20%7C%20Camel%20K%20%7C%20HPA-EE0000?style=for-the-badge)

</div>

| Lab | Title                                                                                                | Core Focus                                    |
| --: | ---------------------------------------------------------------------------------------------------- | --------------------------------------------- |
|  11 | [Exposing RESTful APIs with Camel](./lab11-exposing-restful-apis-with-camel)                         | REST DSL + CRUD + JSON binding + error codes  |
|  12 | [Consuming External REST APIs with Camel](./lab12-consuming-external-rest-apis-with-camel)           | polling + transformation + monitoring routes  |
|  13 | [Deploying Camel Routes on OpenShift](./lab13-deploying-camel-routes-on-openshift)                   | Camel K operator lifecycle + service exposure |
...
![Category](https://img.shields.io/badge/Category-Advanced%20Integration%20Engineering-0F172A?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-Dynamic%20Routing%20%7C%20Scalable%20EIPs-7C3AED?style=for-the-badge)
![Focus](https://img.shields.io/badge/Focus-File%20%7C%20FTP%20%7C%20SFTP%20%7C%20End--to--End-1F6FEB?style=for-the-badge)

</div>

| Lab | Title                                                                      | Core Focus                                                          |
| --: | -------------------------------------------------------------------------- | ------------------------------------------------------------------- |
|  16 | [Dynamic Routing with Camel](./lab16-dynamic-routing-with-camel)           | choice() + JsonPath + recipientList() + external config             |
|  17 | [EIPs for Scalable Integrations](./lab17-eips-for-scalable-integrations)   | Splitter/Aggregator/Recipient List with correlation & parallelism   |
|  18 | [Camel Components — File Handling](./lab18-camel-components-file-handling) | File + FTP + SFTP pipelines with routing + monitoring               |
...
<img src="https://img.shields.io/badge/📥%20File%20Intake-111827?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🧾%20Parse%20CSV-1F2937?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🧠%20DB%20Enrichment-374151?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🌐%20REST%20Inventory%20Check-4B5563?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🔀%20Content--Based%20Routing-6B7280?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🗄️%20Persist%20to%20PostgreSQL-0F172A?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/📨%20Messaging%20Notifications-111827?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🧾%20Generate%20Reports-1F2937?style=flat-square"/>
<img src="https://img.shields.io/badge/→-444444?style=flat-square"/>
<img src="https://img.shields.io/badge/🛡%20Retry%20%2B%20DLQ%20Handling-991B1B?style=flat-square"/>
...
> Design → Build → Test → Deploy → Operate → Validate → Scale
> Each lab is self-contained. Some labs require external services (ActiveMQ, Kafka, OpenShift).
> The required setup + verification commands are documented inside each lab folder.
...
> Some labs require external services (ActiveMQ, Kafka, OpenShift, PostgreSQL).
> Setup, verification commands, and troubleshooting steps are fully documented inside each lab folder.
